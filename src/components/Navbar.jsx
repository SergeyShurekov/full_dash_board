...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mr-6 md:ml-6 relative'>
      <NavButton title="Меню" customFunc={() => setActiveMenu(!activeMenu)} color='blue' icon={<AiOutlineMenu />} />
      ...
      <div className='flex'>
        ...
        />
        <TooltipComponent content="Профиль" position='BottomCenter'>
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={() => handleClick('userProfile')}>
            <img src={avatar} alt='лицо' className='rounded-full w-8 h-8' />
            <p>
